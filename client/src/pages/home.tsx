        ...
        <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-8 lg:gap-12">
          <div>
            ...
            <div className="flex gap-4">
              ...
              <a href="https://www.linkedin.com/company/crispcar/" target="_blank" rel="noopener noreferrer" className="w-10 h-10 rounded-lg bg-background/10 flex items-center justify-center hover:bg-background/20 transition-colors text-background" data-testid="link-social-linkedin" aria-label="Follow us on LinkedIn">
